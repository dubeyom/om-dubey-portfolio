...
import Project2 from "../../../public/assets/labelRuby.png"
...
const Portfolio = () => {
    ...
    const projects = [
        { id: 1, year: 2023, title: "Vidyayantra", description: "We build a end-to-end e-booking application for physics genius ankit.The tech stack used was Nextjs, tailwind , node , express and MongoDb", image: Project1, link: "https://www.vidyayantra.com/" },
        { id: 2, year: 2023, title: "LabelRuby", description: "We build an end-to-end fashion e-commerce website for the craftsmen of Hyderabad called LabelRuby. The tech stack used was Angular and SCSS  ", image: Project2, link: "https://labelruby.com/" },
